...
const About2 = () => {
  ...
  return (
    ...
    <div className="bg-it-black">

    <section className="bg-it-black py-[70px] sm:py-[100px]">
      <div className=" mx-auto grid grid-cols-7 lg:grid-cols-12 gap-10">
        <div className="col-span-12 md:col-span-6">
          <div className="relative w-fit">
            <img src="/images/home-seven/about.png" alt className />
            {!isMobile && 
        ...
        <div className="col-span-12 md:col-span-6">
          <div className="flex items-center h-full">
            <div className="mt-5 md:mt-0">
              ...
              <p className="text-white mt-9 mb-5">
              If owning a franchise is your goal, it’s time to take action! Regardless of the industry sector you wish to explore, the path to ownership typically spans from three months to a year. Here are the general steps to becoming a franchise owner:
              </p>
              <a href="">
                <div className="home-two-btn-white-rev group border-white/10 before:bg-it-blue after:bg-it-blue hover:border-it-blue transition-all duration-500 w-fit">
                  ...
                  <svg className="relative z-10" width={7} height={12} viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path className="group-hover:stroke-white stroke-white transition-all duration-300" d="M1.10254 10.5L4.89543 6.70711C5.22877 6.37377 5.39543 6.20711 5.39543 6C5.39543 5.79289 5.22877 5.62623 4.89543 5.29289L1.10254 1.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </a>
            </div>
