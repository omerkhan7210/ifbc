...
const ListingBox = ({id,bgcolor,svg,min,max})=>{
  ...
  return (
    <div id={id} className={` bg-[${bgcolor}]  w-full col-span-12 md:col-span-4 p-5`}>
...
const HomeBanner = () => {
  ...
  return (
    <>
      <section className="w-full px-5 md:px-10  min-h-[600px]   relative flex flex-col justify-center items-center" style={{ background: "url(/images/banner.png)", backgroundPosition: 'center' }}>
          <div className='absolute w-full h-full bg-custom-heading-color/60 top-0 left-0 z-0' />
          
          <div className="w-full mx-auto flex flex-col gap-10 z-50">
