...
const Testimonials = () => {
  ...
  return (
    ...
    <div className="theme-container mx-auto w-full">
      ...
      <h2 className="max-w-[847px] font-semibold text-24 sm:text-48 text-main-black text-center mx-auto my-8">
    ...
    >
      {reviews?.map((review, index) => (
        <div className="flex flex-col items-center relative pt-[52px] pb-10   md:px-10 bg-white rounded-2xl h-[350px]">
