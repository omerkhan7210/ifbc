...
const SearchingComponent = ({ homepage }) => {
  ...
  return (
    <div className={`relative ${homepage ? "": "mb-4"}`}>
      <input type="search" id="search-field" placeholder="Search Any Listing"
        value={searchKeyword}
        onChange={handleSearchInputChange}
        className="block w-full p-3 text-sm text-black pr-10 outline-none bg-gray-200" />
      {!homepage &&
        <button className=" absolute right-2.5 top-3 w-4 h-4a">
