  ...
  return (
    <PageTransition>
      <div
        ...
        style={{
          background: "url(/images/accounts/results.jfif)",
        ...
        <p className="text-xl text-left text-custom-heading-color mt-5">
          ...
          {result <= 35 ? (
            <>
              ...
              <br />
              <br />
              Congratulations! It appears as though you have some good options,
              BUT there is a delicate order to follow regarding franchise
              funding and franchise selection. Schedule a free consultation with
              a franchise expert to understand the most strategic paths forward
              and what to avoid as you begin the journey to franchise ownership.
              <br />
              <br />
              ...
              the most strategic paths forward. The order in which you act next
              changes your ability to get approved so learn the proper order by
              talking to an expert now.
              <br />
              <br />
            ...
            <>
              ...
              answers provided. There still may be good options but more details
              will need to be provided to see which apply. Follow these steps:
              <br />
              <br />
              "Take free credit soft pull and receive a pre-screening report".
              Receive your report with 24-48 hours. This credit report will not
              affect your credit because it is a soft pull. This report is
