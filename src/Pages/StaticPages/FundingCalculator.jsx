      ...
      <div id="description" className="flex flex-col  gap-5 my-8 ">
        ...
        <div className="md:max-w-3xl md:mx-auto max-md:mx-5">
          <form onSubmit={handleSubmit}>
            ...
            <div className="w-full mx-auto flex justify-center items-center flex-col shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.07),0px_0px_0px_1px_rgba(25,28,33,0.1)] p-5 rounded-3xl">
