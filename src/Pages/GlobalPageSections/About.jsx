    ...
    const listItems = [
        {
            ...
            description: "At IFBC, we champion a transparent, direct, and cost-free pathway to your franchising aspirations. Our unique approach removes the often-burdensome financial barriers and intermediaries from your journey."
        },
        {
            title: "Make a Smart Move with IFBC – Your Trusted Franchise Navigator!",
            description: "At IFBC, we empower your franchise endeavors with seasoned expertise and tailored strategies. Whether you’re exploring new franchise horizons or elevating an established model."
        }
    ];
                    ...
                    <a href="">
                        <div className="home-two-btn-bg py-3.5 group bg-it-black border-it-black w-fit mt-2.5">
                            ...
                            <svg className="relative z-10" width={7} height={12} viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path className="group-hover:stroke-it-black transition-all duration-300" d="M1.10254 10.5L4.89543 6.70711C5.22877 6.37377 5.39543 6.20711 5.39543 6C5.39543 5.79289 5.22877 5.62623 4.89543 5.29289L1.10254 1.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                    </a>
                </div>
        ...
        <div className="col-span-6 mt-5 md:mt-0 order-1 md:order-2 mb-5 md:mb-0">
                    <div className="flex w-full relative justify-end">
                        ...
                        <div className="bg-it-blue p-4 sm:p-[30px] rounded-2xl absolute z-20 bottom-16 left-2 sm:left-0 w-48 sm:w-[295px]">
                            ...
                            <h1 className="text-[27px] leading-[35px] text-white font-semibold tracking-tight max-w-[170px]" data-scroll-qs="scroll" data-count-qs={25} data-type-qs="+ Years of Experience" data-speed-qs={1000}>
