          ...
          <div className="md:text-xl max-md:text-sm md:mx-16 max-md:mx-5">
            <div className="max-md:flex-col flex gap-5">
              <div className="flex flex-col gap-3">
                ...
                <p>
                  ...
                  expert, invites you to embark on a journey through the dynamic
                  realm of business, marked by rich experiences and proven
                ...
                <p>
                  H.S.Tiwana’s ventures are not confined to the tangible aspects
                  of business but extend into the realms of property and
                  finance. His experience as a Realtor provides him a deep
                  understanding of market dynamics and property valuation, while
                  his tenure as a Loan Officer equips him with the financial
                  acumen to navigate the complex financial landscapes of
                  mortgages and loans.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <p>
                ...
                operational efficiency are pivotal for steering a franchise
              ...
              <p>
                ...
                hands-on management to business ownership, afford him a profound
                understanding of the challenges and opportunities encountered at
              ...
              <p>
                ...
                demonstrates his capability to understand various industry
                dynamics and showcases his belief in investing in people and
                opportunities alike.
              </p>
