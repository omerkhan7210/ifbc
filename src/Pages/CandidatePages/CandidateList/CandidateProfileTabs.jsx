...
const CandidateProfileTabs = () => {
  ...
  <div className='flex w-full'>
    ...
    <input type="text" name="activity-search" id="activity-search" placeholder="Search Activity" className='p-[6px] mb-2 bg-gray-50 border-gray-300 border rounded-sm placeholder-[#2176ff] placeholder:text-sm placeholder:font-bold text-black' />
    </div>
  </div>
  ...
  <div className='flex border-2 border-gray-300  rounded-md'>
      <div className=' border-r-2 border-gray-300 p-2'>
        <h1 className='text-[#2176ff] text-sm font-bold '>Formal Registration</h1>
        <p className='text-xs font-medium'>Apr 19, 2024 at 11:31AM</p>
      </div>
      <div className='text-black align-middle justify-center flex p-2'>
        <p className='aligm-middle justify-center py-2 font-normal text-base'>Sent a Formal Registration to Teriyaki Madness for AVON IN 46123</p>
      </div>
    </div>
    <div className='flex border-2 border-gray-300  rounded-md mt-3'>
      <div className=' border-r-2 border-gray-300 p-2'>
        <h1 className='text-[#2176ff] text-sm font-bold '>Updated Profile</h1>
        <p className='text-xs font-medium'>Apr 19, 2024 at 11:31AM</p>
      </div>
      <div className='text-black align-middle justify-center flex p-2'>
        <p className='aligm-middle justify-center py-2 font-normal text-base'>The client was updated by Harjeet Tiwana</p>
      </div>
    </div>
    </div>
        </div>
    ...
    return(
        ...
        className={`candidate-tabs-content ${
          activeTab.toLowerCase() === "fls-criteria" ? "" : "hidden"
            ...
            <div id='container1' className='flex justify-between border-b border-gray-300 pb-4'>
              <div>
                <h2 className='text-black font-semibold text-base'>Section Settings</h2>
              </div>
              <div>
            ...
            <div id='container2' className='py-4 mb-2'>
              <h1 className='text-lg text-[#2176ff] font-bold mb-2'>Franchise Categories</h1>
              <p className='text-sm text-black font-semibold'>Rank the Franchise Categories in order of preference, with 1 being the least favorite and 10 being the most favorite.</p>
            </div>
            ...
            <div className='w-full'>
                ...
                <label className='class="flex gap-x-1 items-center mr-6 '>
                <input type="checkbox" name="Hide Section"  />
                <span className='text-black'>Business Management & Coaching</span>
                </label>
                </div>
            <div className='mt-2'>
               <div className="mr-4 w-full">
            ...
            <div className='w-full'>
                ...
                <label className='class="flex gap-x-1 items-center mr-6 '>
                <input type="checkbox" name="Hide Section"  />
                <span className='text-black'>Child Education, STEM & Tutoring</span>
                </label>
                </div>
            <div className='mt-2'>
               <div className="mr-4 w-full">
            ...
            <div className='w-full'>
                ...
                <label className='class="flex gap-x-1 items-center mr-6 '>
                <input type="checkbox" name="Hide Section"  />
                <span className='text-black'>Cleaning: Residential & Commercial</span>
                </label>
                </div>
            <div className='mt-2'>
               <div className="mr-4 w-full">
            ...
            <div className='w-full'>
                ...
                <label className='class="flex gap-x-1 items-center mr-6 '>
                <input type="checkbox" name="Hide Section"  />
                <span className='text-black'>Select a rating Distribution Services</span>
                </label>
                </div>
            <div className='mt-2'>
               <div className="mr-4 w-full">
            ...
            <div className='w-full'>
                ...
                <label className='class="flex gap-x-1 items-center mr-6 '>
                <input type="checkbox" name="Hide Section"  />
                <span className='text-black'>Food & Beverage: Restaurant/QSR/Catering</span>
                </label>
                </div>
            <div className='mt-2'>
               <div className="mr-4 w-full">
    ...
    return(
        ...
        className={`candidate-tabs-content ${
          activeTab.toLowerCase() === "resources" ? "" : "hidden"
            ...
            <h1 className='text-lg font-bold text-[#2176ff]'>No resources available</h1>
        </div>
    )
  }
          ...
          {/* container 1 */}
            <div id='container1' className='flex'>
              ...
              <div className='flex w-full'>
                {/* input 1 */}
                <div className="mr-3 w-full">
                    <select id="countries" className=" bg-gray-50 border border-gray-300 font-bold text-[#2176ff] text-sm rounded-md focus:font-semibold focus:text-black block w-full p-2 mb-2">
                      <option selected>Select Stage</option>
                      <option value="US">United States</option>
                      <option value="CA">Canada</option>
                      <option value="FR">France</option>
                  ...
                  <div className="dp__main dp__theme_light">
                    <div aria-label="Datepicker input" role="textbox" aria-multiline="false" aria-disabled="false" aria-readonly="false">
                      <div className="dp__input_wrap">
                        <input className="dp__pointer dp__input_readonly dp__input dp__input_icon_pad dp__input_reg" inputMode="none" placeholder autoComplete="off" />
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width={32} height={32} viewBox="0 0 32 32" className="dp__icon dp__input_icon dp__input_icons">
            ...
            {/* container 2 */}
            <div id='container2' className='grid grid-cols-12 divide-x-2 justify-center align-middle mt-4'>
              {/* column 1 */}
            ...
            {/* container 3  */}
            <div id='container 3' className='grid grid-cols-12 divide-x-2 mt-3 rounded-lg'>
