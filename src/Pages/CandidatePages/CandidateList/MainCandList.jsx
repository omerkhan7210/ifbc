...
<div
        ...
        >
          <h1 className="text-7xl text-white font-bold text-center z-20">
           Candidate List
            ...
            <div className="flex flex-col gap-[0.5rem] max-w-7xl pt-10 px-5 mx-auto">
  <div className="md:grid md:grid-cols-3">
    <div className="  flex hidden sm:block">
      <button className="bg-[#2176ff] px-7 py-2 rounded-lg text-white">New Candidate</button>
    </div>
  ...
  <div className="hidden md:block ">
    <div>
      <p className="text-[#2176ff] font-bold text-xl mb-3">Filters:</p>
    </div>
    <div className=" grid grid-cols-4">
      <div className="mr-3">
        <p className="text-slate-500 text-sm font-semibold mb-2">Deal Stage</p>
        <select id="countries" className="bg-gray-50 border border-gray-300 font-bold text-[#2176ff] text-sm rounded-sm focus:font-semibold focus:text-black block w-full p-2 mb-3">
    ...
    <div className="flex ">
      <button className="w-[80%] border-2 bg-[#2176ff] text-white p-2 rounded-md font-bold mr-5"> EXPORT</button>
      <button className="w-[80%] border-2 bg-[#2176ff] text-white p-2 rounded-md font-bold">IMPORT</button>
    </div>
  </div>
  <div className="hidden sm:block mt-2 mb-4">
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table className="w-full text-sm text-left rtl:text-right text-black ">
        <thead className="text-xl text-white uppercase bg-[#2176ff]">
          <tr>
  ...
  <div className="sm:hidden">
    <div className="profile-card w-[300px] rounded-md shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group">
      ...
      <div className="headings *:text-center *:leading-4">
        <p className="text-2xl  font-semibold text-[#434955]">Lovedip Singh</p>
      </div>
...
{/* second page */}
<div className="flex flex-col gap-[0.5rem] max-w-7xl pt-10 px-5 mx-auto mb-10">
  <div className="md:grid md:grid-cols-3">
    <div className="  flex  hidden sm:block">
      <button className="bg-[#2176ff] px-7 py-2 rounded-lg text-white">New Candidate</button>
    </div>
  ...
  <div id="container" className="divide-x-4 flex max-w-[100%] mx-auto overflow-x-scroll">
    {objects.map((object)=>(
  ...
  return(
   ...
   <div className="profile-card p-3 rounded-md border-2 border-[#2176ff] border-solid shadow-xl overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group">
     ...
     <div className="headings">
       <p className="text-2xl text-center font-semibold text-[#434955]">{name}</p>
     </div>
     <div className="w-full items-center justify-center flex">
       <ul className="flex flex-col items-center gap-2 has-[:last]:border-b-0 *:inline-flex *:gap-2 *:items-center *:justify-center *:border-b-[1.5px] *:border-b-stone-700 *:border-dotted *:text-xs *:font-semibold *:text-[#434955] pb-3">
         <li>
           ...
           <p className="text-sm"><a href={`tel:${phone}`}> {phone}</a></p>
         </li>
         <li>
           <svg className="fill-stone-700 group-hover:fill-[#58b0e0]" height={15} width={15} id="mail" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
             <path d="M16,14.81,28.78,6.6A3,3,0,0,0,27,6H5a3,3,0,0,0-1.78.6Z" fill="#231f20" />
