...
const BottomBar = ({ listingContent }) => {
  ...
  useEffect(() => {
    ...
    const history = document.querySelector(".entry-content ul.tabs")
      ?.nextElementSibling?.nextElementSibling;
    const territories = document.querySelector(".entry-content ul.tabs")
      ?.nextElementSibling?.nextElementSibling?.nextElementSibling;
    const financials = document.querySelector(".entry-content ul.tabs")
      ?.nextElementSibling?.nextElementSibling?.nextElementSibling
      ?.nextElementSibling;
    const resources = document.querySelector(".entry-content ul.tabs")
      ?.nextElementSibling?.nextElementSibling?.nextElementSibling
      ?.nextElementSibling?.nextElementSibling;
    const reviewsnotes = document.querySelector(".entry-content ul.tabs")
      ?.nextElementSibling?.nextElementSibling?.nextElementSibling
      ?.nextElementSibling?.nextElementSibling?.nextElementSibling;
