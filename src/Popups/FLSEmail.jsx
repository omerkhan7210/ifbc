...
const FLSEmail = () => {
  const { showEmailPopup, setShowEmailPopup, activeListings } =
  ...
  return (
    <div
      className={`modal modal-container ${showEmailPopup ? "is-open" : ""}`}
      id="fls-email"
    >
      <div className="modal__overlay flex items-center h-screen">
        <div className="modal__container tc-width md:w-[46rem]" role="dialog">
          <header className="modal__header">
            <h2
              className="modal__title text-green text-xl"
              id="fls-email-title"
            >
              Email Concepts
            </h2>
            ...
            <form method="post">
              ...
              {activeListings && activeListings.length > 0 && (
                <div className="territory-zor-list">
                  <p className="mb-2">
                    <strong className="section-description">
