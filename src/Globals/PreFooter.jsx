            ...
            <div className="consultation-section-wrapper w-full relative">
              <div className="theme-container mx-auto relative z-10">
                <div className="w-full py-[80px] bg-it-blue rounded-[20px] md:flex relative overflow-hidden">
                  <img src="/images/home-seven/cta-shape-1.svg" alt className="absolute top-10 left-10" />
                  <img src="/images/home-seven/cta-shape-1.svg" alt className="absolute bottom-10 left-28 h7-cta-open-anim" />
                    ...
                    <a href="">
                      <div className="home-two-btn-white-rev group before:bg-white after:bg-white hover:border-it-blue transition-all duration-500 w-fit">
                        ...
                        <svg className="relative z-10" width={7} height={12} viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path className="group-hover:stroke-it-blue stroke-white transition-all duration-300" d="M1.10254 10.5L4.89543 6.70711C5.22877 6.37377 5.39543 6.20711 5.39543 6C5.39543 5.79289 5.22877 5.62623 4.89543 5.29289L1.10254 1.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                      </div>
                    </a>
                  </div>
